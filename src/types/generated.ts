...
export type FetchProfile = { profiles: { items: Array<{ id: string, name?: string | undefined, bio?: string | undefined, followNftAddress?: string | undefined, metadata?: string | undefined, isDefault: boolean, handle: string, ownedBy: string, attributes?: Array<{ displayType?: string | undefined, traitType?: string | undefined, key: string, value: string }> | undefined, picture?: { __typename: 'MediaSet', original: { url: string, mimeType?: string | undefined } } | { __typename: 'NftImage', contractAddress: string, tokenId: string, uri: string, verified: boolean } | undefined, coverPicture?: { __typename: 'MediaSet', original: { url: string, mimeType?: string | undefined } } | { __typename: 'NftImage', contractAddress: string, tokenId: string, uri: string, verified: boolean } | undefined, dispatcher?: { address: string, canUseRelay: boolean } | undefined, stats: { totalFollowers: number, totalFollowing: number, totalPosts: number, totalComments: number, totalMirrors: number, totalPublications: number, totalCollects: number }, followModule?: { type: FollowModules, recipient: string, amount: { value: string, asset: { symbol: string, name: string, decimals: number, address: string } } } | { type: FollowModules } | { type: FollowModules } | undefined }>, pageInfo: { prev?: string | undefined, next?: string | undefined, totalCount: number } } };
